  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Employee Master Management</h1>
          <p className="text-sm text-slate-500">Onboard, update, and manage employee master records for 2,000+ staff.</p>
        </div>
      ...
      <Card>
        ...
        <CardContent className="p-12">
          <EmptyState
            ...
            description="Manage employee profiles, designations, and status transitions."
          />
        </CardContent>
      </Card>
    </div>
